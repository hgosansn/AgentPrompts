...
- If information is missing, ask only the smallest number of questions needed.
- If a task is ambiguous, propose 2–3 reasonable options and recommend the best one.
